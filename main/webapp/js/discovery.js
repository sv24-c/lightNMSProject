...
var discoverymain = {
    ...
    add: function ()
    {
        ...
        $("#add-btn").on("click", function ()
        {
            ...
            if (name && ip && type && username && password)
            {
                if(type==="Ping")
                {
                    let request = {
            ...
            else
            {
                if (name==="")
                {
                    toastr.warning("Name Field Required to Fill");
                }
                if(ip==="")
                {
                    toastr.warning("IP Field Required to Fill");
                }
                if(type==="SSH" && username==="")
                {
                    toastr.warning("Username Field Required to Fill");
                }
                if(type==="SSH" && password==="")
                {
                    toastr.warning("Password Field Required to Fill");
                }
            }
    ...
    edit: function (context)
    {
        ...
        if($(context).parent().prev().text()==="SSH")
        {
            deviceType = "SSH";
