...
<%--<div class="col-md-12">
    <button type="button" class="btn btn-primary col-md-1">M</button>
    <button type="button" class="btn btn-primary col-md-2"><i class="fa fa-tachometer"></i> Dashboard</button>
    <button type="button" class="btn btn-secondary col-md-2" id="discovery-btn"><i class="fa fa-search"></i> Discovery</button>
    <button type="button" class="btn btn-success col-md-2"><i class="fa fa-desktop"></i> Monitor</button>
    <button type="button" class="btn btn-danger col-md-2"><i class="fa fa-user"></i>Profile</button>
    <button type="button" class="btn btn-warning col-md-2"><a href="logoutProcess"><i class="fa fa-sign-out"></i>Logout</a></button>
</div>--%>
...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="DashboardClick">
